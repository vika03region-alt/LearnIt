...
╔═══════════════════════════╗
   🤖 <b>AI ПОМОЩНИК ДЛЯ TELEGRAM</b>
╚═══════════════════════════╝

Привет! Я помогу автоматизировать твой канал 🚀

<b>✨ ЧТО Я УМЕЮ:</b>

🎬 <b>AI ВИДЕО (БЕСПЛАТНО!)</b>
   • Генерация видео из текста
   • 100% бесплатно, без лимитов
   • Автопубликация в канал

📝 <b>КОНТЕНТ</b>
   • Вирусные посты и идеи
   • Хештеги и цепляющие хуки
...
💬 <b>AI АССИСТЕНТ</b>
Просто напиши вопрос - отвечу на всё!

━━━━━━━━━━━━━━━━━━━━━━━━━
🎯 /menu - Все возможности
📢 Канал: ${CHANNEL_ID}
━━━━━━━━━━━━━━━━━━━━━━━━━
    `;
...
<b>🎬 AI ВИДЕО (НОВИНКА!)</b>
━━━━━━━━━━━━━━━━━━━━━━━
/aivideo - Создать AI видео бесплатно 🎥
...
━━━━━━━━━━━━━━━━━━━━━━━
💬 <b>AI АССИСТЕНТ ВСЕГДА НА СВЯЗИ</b>
Пиши любой вопрос - отвечу!
━━━━━━━━━━━━━━━━━━━━━━━

<b>⚡ БЫСТРЫЙ СТАРТ:</b>
1️⃣ /aivideo - создай видео с AI
2️⃣ /viral - или текстовый пост
3️⃣ /publish - опубликуй в канал

🎯 Всё просто! Попробуй /aivideo
    `;
...
/pause - Остановить автопостинг ⏸️
/resume - Возобновить ▶️
/mystats - Твоя статистика ⭐

<b>💬 AI АССИСТЕНТ</b>
━━━━━━━━━━━━━━━━━━━━━━━
Просто пиши вопросы - отвечу на всё!
...
<b>💡 СОВЕТ:</b> Начни с /aivideo или /viral
    `;
...
/uploadvideo - загрузить видео на канал`;
  ...
  // AI Генерация видео (Hugging Face - бесплатно!)
  bot.onText(/\/aivideo(?:\s+(.+))?/, async (msg, match) => {
    const chatId = msg.chat.id;
    const topic = match?.[1];

    if (!topic) {
      const helpMsg = `🎬 <b>AI ГЕНЕРАТОР ВИДЕО (100% БЕСПЛАТНО!)</b>

🌟 <b>Что это?</b>
Создание профессиональных видео из текста с помощью AI.
Hugging Face LTX-Video - полностью бесплатно, без лимитов!

📹 <b>Технические характеристики:</b>
• Длительность: 5-10 секунд
• Разрешение: 768×512 (идеально для соцсетей)
• Скорость: 10-20 секунд генерации
• Стоимость: $0.00 (бесплатно навсегда!)
...
• /aivideo trader analyzing crypto charts
• /aivideo golden coins falling from sky
• /aivideo stock market bull run visualization

✨ <b>Советы для лучших результатов:</b>
1. Используйте короткие, четкие описания
2. Укажите визуальные детали
3. Добавьте настроение (cinematic, professional)
4. На английском языке работает лучше всего

⚡ Попробуй прямо сейчас!
Пример: /aivideo crypto trading success story`;
    ...
    try {
      await bot!.sendMessage(chatId, '🎬 Генерирую AI видео... (10-30 секунд)\n\n✨ Используется Hugging Face LTX-Video\n💰 Стоимость: $0.00 (бесплатно!)');

      // Импортируем сервис
      const { huggingFaceVideoService } = await import('./services/huggingFaceVideoService');
      ...
      console.log(`🎬 Генерация видео для промпта: ${videoPrompt}`);
...
🚀 Отправляю видео...`, { parse_mode: 'HTML' });
        ...
        await bot!.sendVideo(chatId, result.videoUrl, {
          caption: `🎬 AI Видео: ${topic}\n\n✨ Создано бесплатно с Hugging Face LTX-Video`
        });

        await bot!.sendMessage(chatId, '✨ Хочешь опубликовать это видео в канал?\nИспользуй /publish для публикации!');
      } else if (result.status === 'processing') {
        await bot!.sendMessage(chatId, '⏳ Видео генерируется... Это может занять до 30 секунд.\n\n💡 Попробуйте команду ещё раз через минуту.');
      } else {
      ...
      console.error('❌ Ошибка генерации AI видео:', error);
      await bot!.sendMessage(chatId, `❌ Ошибка: ${error.message || 'Не удалось создать видео'}

💡 <b>Альтернативные варианты:</b>
1. Попробуйте ещё раз через минуту
2. Используйте более простое описание на английском
3. Загрузите своё видео: /uploadvideo

<b>Технические детали:</b>
${error.message || 'Неизвестная ошибка'}`, { parse_mode: 'HTML' });
    }
  });
