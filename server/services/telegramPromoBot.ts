...
class TelegramPromoBot {
  ...
  private setupHandlers() {
    ...
    this.bot.onText(/\/start/, async (msg) => {
      ...
      // Отправляем уведомление об активации Pro
      await bot!.sendMessage(
        chatId,
        `🎉 <b>PRO ПЛАН АКТИВИРОВАН!</b>
...
• 5 платформ одновременно
• Viral Growth Engine
• Brand Domination System
...
/viral - генерация вирусного контента
/autopilot - запуск автопилота
/domination - план доминирования
/analytics - глубокая аналитика

💪 Теперь у вас есть ВСЕ инструменты для захвата рынка!`,
        { parse_mode: 'HTML' }
      );
